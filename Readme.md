README – Calculatrice LEX/YACC

Présentation
Ce programme analyse et évalue des expressions arithmétiques à l’aide de Flex (LEX) et Bison (YACC).
En sortie, il affiche :
- la forme postfixée (RPN)
- un code intermédiaire TAC (three-address code)
...
Fonctions disponibles (arguments séparés par des virgules)
./calc "somme(1,2,3,4)"
./calc "produit(2,3,4)"
./calc "moyenne(2,4)"
./calc "variance(2,4)"
...
- Postfix : expression en notation postfixée (RPN)
- TAC : code à trois adresses avec temporaires (t1, t2, …)
- Valeur : résultat final de l’évaluation
