...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SOMME = 4,                      /* SOMME  */
  YYSYMBOL_PRODUIT = 5,                    /* PRODUIT  */
  YYSYMBOL_MOYENNE = 6,                    /* MOYENNE  */
  YYSYMBOL_VARIANCE = 7,                   /* VARIANCE  */
  YYSYMBOL_ECART_TYPE = 8,                 /* ECART_TYPE  */
  YYSYMBOL_LEX_ERROR = 9,                  /* LEX_ERROR  */
  YYSYMBOL_10_ = 10,                       /* '+'  */
  YYSYMBOL_11_ = 11,                       /* '-'  */
  YYSYMBOL_12_ = 12,                       /* '*'  */
  YYSYMBOL_13_ = 13,                       /* '/'  */
  ...
  YYSYMBOL_funcname = 23,                  /* funcname  */
  YYSYMBOL_arglist_opt = 24,               /* arglist_opt  */
  YYSYMBOL_arglist = 25                    /* arglist  */
};
...
{
       0,   101,   101,   104,   105,   106,   110,   111,   112,   116,
     117,   118,   119,   120,   124,   136,   137,   138,   139,   140,
     144,   145,   149,   150
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "SOMME",
  "PRODUIT", "MOYENNE", "VARIANCE", "ECART_TYPE", "LEX_ERROR", "'+'",
  "'-'", "'*'", "'/'", "'('", "')'", "','", "$accept", "program", "expr",
  "term", "factor", "funcall", "funcname", "arglist_opt", "arglist", YY_NULLPTR
};
...
{
      14,   -10,   -10,   -10,   -10,   -10,   -10,   -10,    14,    14,
       1,    -5,    -3,   -10,   -10,    -1,   -10,    -7,   -10,    14,
      14,    14,    14,    14,   -10,    -3,    -3,   -10,   -10,    -5,
      11,    13,   -10,    14,    -5
};
...
{
       0,    11,    15,    16,    17,    18,    19,    13,     0,     0,
       0,     2,     5,     8,    12,     0,     9,     0,     1,     0,
       0,     0,     0,    20,    10,     3,     4,     6,     7,    22,
       0,    21,    14,     0,    23
};
...
{
     -10,   -10,    -9,    -8,    -6,   -10,   -10,   -10,   -10
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,    10,    11,    12,    13,    14,    15,    30,    31
};
...
{
      17,    18,    16,    19,    20,    19,    20,     0,    24,    21,
      22,    25,    26,    23,    29,    27,    28,     1,     2,     3,
       4,     5,     6,     7,    34,     8,    32,     0,     9,    33
};

static const yytype_int8 yycheck[] =
{
       9,     0,     8,    10,    11,    10,    11,    -1,    15,    12,
      13,    19,    20,    14,    23,    21,    22,     3,     4,     5,
       6,     7,     8,     9,    33,    11,    15,    -1,    14,    16
};
...
static const yytype_int8 yystos[] =
{
      ...
      18,    19,    20,    21,    22,    23,    21,    19,     0,    10,
      11,    12,    13,    14,    15,    20,    20,    21,    21,    19,
      24,    25,    15,    16,    19
};
...
#line 104 "parser.y"
                  { (yyval.node) = mk_bin('+', (yyvsp[-2].node), (yyvsp[0].node), (yylsp[-2])); }
...
#line 116 "parser.y"
                          { (yyval.node) = mk_un('n', (yyvsp[0].node), (yylsp[-1])); }
...
#line 118 "parser.y"
                          { (yyval.node) = mk_num((yyvsp[0].dval), (yylsp[0])); }
#line 1604 "parser.tab.c"
    break;

  case 12: /* factor: funcall  */
#line 119 "parser.y"
                          { (yyval.node) = (yyvsp[0].node); }
#line 1610 "parser.tab.c"
    break;

  case 13: /* factor: LEX_ERROR  */
#line 120 "parser.y"
                          { (yyval.node) = mk_num(0.0, (yylsp[0])); had_error = 1; }
#line 1616 "parser.tab.c"
    break;

  case 14: /* funcall: funcname '(' arglist_opt ')'  */
#line 125 "parser.y"
      {
        if ((yyvsp[-1].list) == NULL) {
          sem_error((yylsp[-3]), "appel de fonction sans arguments");
          (yyval.node) = mk_num(0.0, (yylsp[-3]));
        } else {
          (yyval.node) = mk_func((yyvsp[-3].fkind), (yyvsp[-1].list), (yylsp[-3]));
        }
      }
#line 1629 "parser.tab.c"
    break;

  case 15: /* funcname: SOMME  */
#line 136 "parser.y"
               { (yyval.fkind) = SOMME; }
#line 1635 "parser.tab.c"
    break;

  case 16: /* funcname: PRODUIT  */
#line 137 "parser.y"
               { (yyval.fkind) = PRODUIT; }
#line 1641 "parser.tab.c"
    break;

  case 17: /* funcname: MOYENNE  */
#line 138 "parser.y"
               { (yyval.fkind) = MOYENNE; }
#line 1647 "parser.tab.c"
    break;

  case 18: /* funcname: VARIANCE  */
#line 139 "parser.y"
               { (yyval.fkind) = VARIANCE; }
#line 1653 "parser.tab.c"
    break;

  case 19: /* funcname: ECART_TYPE  */
#line 140 "parser.y"
               { (yyval.fkind) = ECART_TYPE; }
#line 1659 "parser.tab.c"
    break;

  case 20: /* arglist_opt: %empty  */
#line 144 "parser.y"
               { (yyval.list) = NULL; }
#line 1665 "parser.tab.c"
    break;

  case 21: /* arglist_opt: arglist  */
#line 145 "parser.y"
               { (yyval.list) = (yyvsp[0].list); }
#line 1671 "parser.tab.c"
    break;

  case 22: /* arglist: expr  */
#line 149 "parser.y"
                      { (yyval.list) = list_single((yyvsp[0].node)); }
#line 1677 "parser.tab.c"
    break;

  case 23: /* arglist: arglist ',' expr  */
#line 150 "parser.y"
                      { (yyval.list) = list_append((yyvsp[-2].list), (yyvsp[0].node)); }
